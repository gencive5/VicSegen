  ...
  return (
    <>
      ...
      <button 
        ...
        className="fixed top-0 left-1/2 transform -translate-x-1/2 z-60 bg-about-button bg-no-repeat bg-center bg-contain hover:opacity-90 transition-opacity"
        style={{ width: '140px', height: '70px' }}
        aria-label="About"
     />

      {/* Mobile - Right Column (hidden on desktop) */}
      <div className="sm:hidden fixed right-0 top-1/2 transform -translate-y-1/2 flex flex-col gap-6 z-60 items-end opacity-80">
        <button 
        ...
        <button 
          ...
          className="custom-button bg-sm00ch-button hover:opacity-80 transition-opacity z-60"
          style={{ width: '120px', height: '120px' }}
